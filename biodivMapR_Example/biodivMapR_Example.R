...
# terrain_colors <- terrain.colors(60)
# try <- rast("biodivMapR_Example/03_RESULTS/S2A_T33NUD_20180104_Subset/SPCA/PCA/OutputPCA_8_PCs")
# plot(try, col=terrain_colors, legend=F)
...
Kmeans_info <- map_spectral_species(Input_Image_File = Input_Image_File,
                                    ...
                                    SelectedPCs = c(1,2,5))
#spectral_sp_map <- rast("biodivMapR_Example/03_RESULTS/S2A_T33NUD_20180104_Subset/SPCA/SpectralSpecies/SpectralSpecies")
