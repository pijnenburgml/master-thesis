...
# Mean elevation at different scale 
tile_DEM_proj <- rast("~/data/ArcDEM/tile_DEM_proj.tif")
area_interest <- st_read("~/data/areas_of_interest.gpkg")
area_interest_proj <- st_transform(area_interest,32613)
ext(area_interest_proj)
...
# sd(slope) at different resolution
tile_DEM_proj <- rast("~/data/ArcDEM/tile_DEM_proj.tif")
area_interest <- st_read("~/data/areas_of_interest.gpkg")
area_interest_proj <- st_transform(area_interest,32613)
ext(area_interest_proj)
...
for(x in 1:length(fact)){
  ...
  writeRaster(slope_mask, filename = paste("~/data/ArcDEM/sd_slope_masked_", window_size[x], "_res.tif", sep=""))
}
...
save(Gamma_shannon_sd_slope_res_300, file="~/scratch/INLA_modelling/Gamma_shannon_sd_slope_res_300.Rdata")
...
save(Gamma_shannon_sd_slope_res_500, file="~/scratch/INLA_modelling/Gamma_shannon_sd_slope_res_500.Rdata")
...
save(Gamma_shannon_sd_slope_res_1000, file="~/scratch/INLA_modelling/Gamma_shannon_sd_slope_res_1000.Rdata")
...
#   f(node, model="matern2d", nrow=nrow, ncol=ncol)
# 
# Gamma_shannon_topo_res100 <- inla(formula,     
#                                   family = "gamma",
#                                   data = data,
#                                   control.compute = list(cpo = T, dic = T, waic = T,return.marginals.predictor=TRUE), verbose=TRUE)
# 
# summary(Gamma_shannon_topo_res100)
# save(Gamma_shannon_topo_res100, file="~/scratch/INLA_modelling/Gamma_shannon_topo_res100.Rdata")
# get(load("~/scratch/INLA_modelling/Gamma_shannon_topo_res100.Rdata"))
# observed <- data$Shannon_index
...
# save(Gamma_shannon_topo_res200, file="~/scratch/INLA_modelling/Gamma_shannon_topo_res200.Rdata")
# get(load("~/scratch/INLA_modelling/Gamma_shannon_topo_res200.Rdata"))
# 
...
# 
# save(Gamma_shannon_topo_res500, file="~/scratch/INLA_modelling/Gamma_shannon_topo_res500.Rdata")
# get(load("~/scratch/INLA_modelling/Gamma_shannon_topo_res500.Rdata"))
# 
# 
...
# 
# save(Gamma_shannon_topo_res1000, file="~/scratch/INLA_modelling/Gamma_shannon_topo_res1000.Rdata")
# get(load("~/scratch/INLA_modelling/Gamma_shannon_topo_res1000.Rdata"))
# 
# #################
# # plotting
